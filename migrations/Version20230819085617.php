 ...
 */
final class Version20230819085617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE airport_hotel ADD printing_options_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE airport_hotel ADD CONSTRAINT FK_74CC422C5189E7C7 FOREIGN KEY (printing_options_id) REFERENCES printing_options (id)');
        $this->addSql('CREATE INDEX IDX_74CC422C5189E7C7 ON airport_hotel (printing_options_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE airport_hotel DROP FOREIGN KEY FK_74CC422C5189E7C7');
        ...
        $this->addSql('DROP INDEX IDX_74CC422C5189E7C7 ON airport_hotel');
        $this->addSql('ALTER TABLE airport_hotel DROP printing_options_id');
    }
}
